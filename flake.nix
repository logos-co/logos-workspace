{
  ...
  inputs = {
    ...
    logos-lidl = {
      url = "github:logos-co/logos-lidl/ae3ffe0fe9e7e020dc259208a67ca8823fcab93a";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-protocol = {
      url = "github:logos-co/logos-protocol/43cd05960894383223e7acf98c4d48b38a68d05a";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-qt-sdk = {
      url = "github:logos-co/logos-qt-sdk/75366db3e764e5335e0db0f81faf0e88658ff1ec";
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/234d6f66951dcdb1322e65c0d19a8bd33bdfdb8c";
      inputs.logos-lidl.follows = "logos-lidl";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    logos-view-module-runtime = {
      url = "github:logos-co/logos-view-module-runtime/471dd56640331cd7b1a94c0623d419002da383a6";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
    ...
    logos-container = {
      url = "github:logos-co/logos-container/06d43aeda169fffe1bb07a7cf9f375d5bc049184";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-module-loader = {
      url = "github:logos-co/logos-module-loader/3628b97a32cb2edb30e7d26c0c5113a487e3e993";
      inputs.logos-container.follows = "logos-container";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-container-subprocess = {
      url = "github:logos-co/logos-container-subprocess/5c6aefcf4f185c94a92fa1345221c211fde8ef84";
      inputs.logos-container.follows = "logos-container";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/fdb9b4a586622ac9919ed2c2001f8f64a4173f80";
    ...
    logos-module-loader-qt = {
      url = "github:logos-co/logos-module-loader-qt/e648735cbbc67c97daeecf1fcaf52a7c0dc7f87c";
      inputs.logos-container.follows = "logos-container";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-module-loader.follows = "logos-module-loader";
    ...
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/8917dff5adf01a442bd9a2ebdd4216d68f26b40e";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-capability-module = {
      url = "github:logos-co/logos-capability-module/c670f7f2cf30acc40d2a3c5266ae08c8d21ceb7d";
    ...
    logos-plugin-qt = {
      url = "github:logos-co/logos-plugin-qt/9b2c64e5a480245b5333e20183a4a3c572d543cc";
      inputs.logos-lidl.follows = "logos-lidl";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
    ...
    logos-view-module-nim = {
      url = "github:logos-co/logos-view-module-nim/e9b50b7635fa1641cacd00cd223f912ade8afacb";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-plugin-qt.follows = "logos-plugin-qt";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-module-builder = {
      url = "github:logos-co/logos-module-builder/378bdba4ed633c79555b50aad22233c42f4f32e7";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/0ac99aebbb72a8a18377decabf7ddfad4b5e2e55";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-package-manager-ui = {
      url = "github:logos-co/logos-package-manager-ui/39a5fa5abb4d9a00d395496b996b923b05935833";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package.follows = "logos-package";
    ...
    logos-rust-sdk.url = "github:logos-co/logos-rust-sdk/f15a0124bd078785c87e6c9f0c92e4f9fbf1be91";
    logos-logoscore-py = {
    ...
    logos-test-modules = {
      url = "github:logos-co/logos-test-modules/626fbaa032fdf5c39a76f472126dc2a2dc67e785";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-logoscore-cli.follows = "logos-logoscore-cli";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-nix.follows = "logos-nix";
