{
  ...
  inputs = {
    ...
    logos-view-module-runtime = {
      url = "github:logos-co/logos-view-module-runtime/da1069ae9dd58fbe6cdae783d37210cbd5610fe7";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-plugin-qt.follows = "logos-plugin-qt";
      inputs.logos-protocol.follows = "logos-protocol";
    ...
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/71dabe0f285947e72936e1e0f9fd66975a5cd0df";
    ...
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/d04768d7f97547b497cbf83342198483a5502ad1";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-standalone-app = {
      url = "github:logos-co/logos-standalone-app/65098c784b11fc6c77022812fc648188e6abef27";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/0157a66386899d9a7627e52f59e03ffe6ca13a51";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-chat-module = {
      url = "github:logos-co/logos-chat-module/9fe2ac426a086c4a1576a63e1c7fd7575ddf00b8";
      inputs.logos-delivery-module.follows = "logos-delivery-module";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-chat-ui = {
      url = "github:logos-co/logos-chat-ui/b4b6d7ab267c63d34b0e2139864952195c0e4ffc";
    ...
    logos-package-manager-ui = {
      url = "github:logos-co/logos-package-manager-ui/41040b0a9c01f38128335e287c6ef0ad1a431ec1";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package.follows = "logos-package";
    ...
    logos-storage-module = {
      url = "github:logos-co/logos-storage-module/bcc29f05e2a7b4a2d215d09640aaa7436359906b";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-storage-ui = {
    ...
    logos-delivery-module = {
      url = "github:logos-co/logos-delivery-module/7f938d8aa4256c4d1a680c5a30c7ecdf662274b0";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-delivery-demo = {
      url = "github:logos-co/logos-delivery-demo/7c5655e155fdfa5983f2cb1c641757ebcb655e62";
      inputs.delivery_module.follows = "logos-delivery-module";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-blockchain-module = {
      url = "github:logos-blockchain/logos-blockchain-module/9d04c54e0c22239161e33c584baede16524bbf1c";
      inputs.logos-blockchain.follows = "logos-blockchain";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-blockchain-ui = {
      url = "github:logos-blockchain/logos-blockchain-ui/800c255f665ac5c93ebf6efa3d2179b5a7a49b91";
    ...
    logos-design-system = {
      url = "github:logos-co/logos-design-system/993f5a1ec0caee6fa4357e699e67ee1c259f5acf";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
      inputs.nix-bundle-macos-app.follows = "nix-bundle-macos-app";
    ...
    logos-test-modules = {
      url = "github:logos-co/logos-test-modules/d093473b3e40fe3d21c72090300c3f259bb237dc";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-logoscore-cli.follows = "logos-logoscore-cli";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-evm-keystore-module = {
      url = "github:logos-co/logos-evm-keystore-module/0a703200113088e0dee093dbafb8d93a32fe8e3b";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-evm-eth-rpc-module = {
      url = "github:logos-co/logos-evm-eth-rpc-module/1f075017e1595ee04e73c0470c98919c47815331";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-evm-token-list-module = {
      url = "github:logos-co/logos-evm-token-list-module/64f82589e1b9ae2474d3c3e99757d181e0afafcd";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-evm-uniswap-module = {
      url = "github:logos-co/logos-evm-uniswap-module/e9fef0ac9cad3948f1eb7e77975157cfc91ddc7b";
