{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-co/logos-protocol/f4407ff4854bdaf486182547af5b55f4a0f55229";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-qt-sdk = {
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/853a261b6d35fae8f95c5526fe355d892f4b7511";
      inputs.logos-lidl.follows = "logos-lidl";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    logos-container-subprocess = {
      url = "github:logos-co/logos-container-subprocess/c6f7ec62792beda0480f8f4a095dbacadd06910a";
    ...
    logos-rust-sdk = {
      url = "github:logos-co/logos-rust-sdk/7c65d318611cae6891f96be3ce64f2ed4554843e";
      inputs.logos-lidl.follows = "logos-lidl";
    };
    logos-logoscore-py = {
    ...
    logos-test-modules = {
      url = "github:logos-co/logos-test-modules/0cc81164b59a14963584f4b67cac175e533ad70c";
      inputs.logos-liblogos.follows = "logos-liblogos";
      inputs.logos-logoscore-cli.follows = "logos-logoscore-cli";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-dev-boost = {
      url = "github:logos-co/logos-dev-boost/a91569992d845bedf8d554bc23c41e4cb84de87e";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-logoscore-tui = {
