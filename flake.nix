{
  ...
  inputs = {
    ...
    logos-lidl = {
      url = "github:logos-co/logos-lidl/dd3440183b14a9d94758ff3c5a322875cc6a3147";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-protocol = {
      url = "github:logos-co/logos-protocol/40180d19cbc38ae84d56ed090cc074d68af0a5ff";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-qt-sdk = {
      url = "github:logos-co/logos-qt-sdk/9e5ddf1f19a6dbdb091264fc20f356ecf4ed5221";
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/1e516c02cec71b35a8ac97a6c23973c4ce59c8fb";
      inputs.logos-lidl.follows = "logos-lidl";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
