{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-co/logos-protocol/ae2f7e1b5842d62836091c6dc0c903508806456e";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-qt-sdk = {
      url = "github:logos-co/logos-qt-sdk/09365f5e048b75422c7a95169c03b82bdea3b918";
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/2ac8e8fc1799ecc6c9a25b08696c16264411472d";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    logos-capability-module = {
      url = "github:logos-co/logos-capability-module/390486e225dcbf7e95072808f3130a35e4a694c6";
    ...
    logos-module-builder = {
      url = "github:logos-co/logos-module-builder/8e4ea1c1d0e523cea46850f8fd9466dd35af7cc1";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-standalone-app = {
      url = "github:logos-co/logos-standalone-app/0d4b65212196ad3fdeea76ac5c2756e2397ed9da";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/a231f502e61e0aad72cef1855eb13f172e92ed7f";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-chat-module = {
      url = "github:logos-co/logos-chat-module/4983eb7343057bc12d51f6e7067ffb9cb681403a";
      inputs.logos-delivery-module.follows = "logos-delivery-module";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-chat-ui = {
      url = "github:logos-co/logos-chat-ui/e6f2682e70868a2679a4e20ed372127ec5b339a2";
    ...
    logos-package-downloader = {
      url = "github:logos-co/logos-package-downloader/02503323b46ec35148ad00cd636d46ac8f2506b5";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-package-downloader-module = {
      url = "github:logos-co/logos-package-downloader-module/19994dc92d6e0b41b6ebba484f22dc7f5dd1c645";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package-downloader.follows = "logos-package-downloader";
    };
    logos-package-manager-ui = {
      url = "github:logos-co/logos-package-manager-ui/dfb0c208b12df9604ef7825125acca59d6ef9e01";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package.follows = "logos-package";
    ...
    logos-delivery-module = {
      url = "github:logos-co/logos-delivery-module/c21ffb83b2b891843de9a940dd60e5e56c8803de";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-delivery-demo = {
    ...
    logos-blockchain-module = {
      url = "github:logos-blockchain/logos-blockchain-module/2946e0f853aea2783286862ca315212cd7950916";
      inputs.logos-blockchain.follows = "logos-blockchain";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-blockchain-ui = {
      url = "github:logos-blockchain/logos-blockchain-ui/48582abcc409c9951c81d335cc9b877bc06cb223";
    ...
    logos-libp2p-module = {
      url = "github:logos-co/logos-libp2p-module/eb8f89f3af59b66caccd51d5f792d500c8b4d3fc";
      inputs.logos-module-builder.follows = "logos-module-builder";
    ...
    logos-design-system = {
      url = "github:logos-co/logos-design-system/32cc9b40195b1f42b8a8c1affb56ebd3dcfef7f4";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
      inputs.nix-bundle-macos-app.follows = "nix-bundle-macos-app";
