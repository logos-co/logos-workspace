{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-co/logos-protocol/c6234940fc030af2fd5c445db82120dc2162887f";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-qt-sdk = {
      url = "github:logos-co/logos-qt-sdk/9020fa99f214458fd1f1c69a8ed16e02536ac9f9";
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/31b9d2bf5f2b7542df50d07c1050b865b4b30de8";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-protocol.follows = "logos-protocol";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    logos-module = {
      url = "github:logos-co/logos-module/7583396720a33153f4bec85c1464bc463fb95477";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/bcccf2db6562439ea124aab06af5bf8125adf2a3";
    ...
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/859c365ea15acd27cc9acfcebbb092d26d491585";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-capability-module = {
      url = "github:logos-co/logos-capability-module/e5373f252468b2b7999d96d4d248cbb5c3ccbdd4";
    ...
    logos-module-builder = {
      url = "github:logos-co/logos-module-builder/0325d6aa9d5737fca461482c204f594339da24e2";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/7769ed95eee1cd5443670513b34f65ec5fec3ac0";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-design-system.follows = "logos-design-system";
      inputs.logos-liblogos.follows = "logos-liblogos";
    ...
    logos-accounts-module = {
      url = "github:logos-co/logos-accounts-module/8b4eceb56fcb54c148affa38dfe6d8e72aedd3e3";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-accounts-ui = {
      url = "github:logos-co/logos-accounts-ui/008e2d848caff272a7a1ffacc5644727394f26af";
      inputs.accounts_module.follows = "logos-accounts-module";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-chat-module = {
      url = "github:logos-co/logos-chat-module/f6043d5f6fba7e870e807f2b5d26a52db716b2b1";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-chat-ui = {
      url = "github:logos-co/logos-chat-ui/7f51db696cd6ceb24c6cac72596eed2a59f2c227";
    ...
    logos-package-downloader = {
      url = "github:logos-co/logos-package-downloader/736f8ebcf06f754a58e80bde0a51645070418573";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-package-manager-module = {
      url = "github:logos-co/logos-package-manager-module/439b580b115718a3b2e1637f2816b8ea6ea7decc";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package-manager.follows = "logos-package-manager";
    };
    logos-package-downloader-module = {
      url = "github:logos-co/logos-package-downloader-module/02fcb4abd85fe2eef26094dd3cb46ed5585867c8";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package-downloader.follows = "logos-package-downloader";
    };
    logos-package-manager-ui = {
      url = "github:logos-co/logos-package-manager-ui/33f5ba06dff624c722083711e48aeed6cb2ad4b4";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package.follows = "logos-package";
    ...
    logos-storage-module = {
      url = "github:logos-co/logos-storage-module/984da34f95a4c252b3852d311c1298c5a3e81ecf";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-storage-ui = {
      url = "github:logos-co/logos-storage-ui/c7bf3177325b4cfbab6725bf43731d88eaadd656";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
      inputs.storage_module.follows = "logos-storage-module";
    };
    logos-wallet-module = {
      url = "github:logos-co/logos-wallet-module/16fdcd4acd37cbd7e17d24517a806e1d15e3ed27";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-wallet-ui = {
      url = "github:logos-co/logos-wallet-ui/c3e0d0d7ebdd5ba0b28eda6cf3b8733a12c759da";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
      inputs.wallet_module.follows = "logos-wallet-module";
    };
    logos-delivery-module = {
      url = "github:logos-co/logos-delivery-module/794c21cbe177bdea16d4907468eaf52d4282dda7";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-delivery-demo = {
    ...
    logos-blockchain-module = {
      url = "github:logos-blockchain/logos-blockchain-module/4c8df124929c6e86d21e2f0db50a99dedee901b3";
      inputs.logos-blockchain.follows = "logos-blockchain";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-blockchain-ui = {
      url = "github:logos-blockchain/logos-blockchain-ui/36ab36dcdec6c496cb8c9fd41b2961a0a0f7c2be";
      inputs.liblogos_blockchain_module.follows = "logos-blockchain-module";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-execution-zone-wallet-ui = {
      url = "github:logos-blockchain/logos-execution-zone-wallet-ui/4e11c4348afce0e0eeaae8186aefd700e2c8f0fc";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos_execution_zone.follows = "logos-execution-zone-module";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-execution-zone-module = {
      url = "github:logos-blockchain/logos-execution-zone-module/5537c0065eee0abf098bb53a2caf108aa3e94d10";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-libp2p-module = {
    ...
    logos-design-system = {
      url = "github:logos-co/logos-design-system/491e522cb94c819c85bf87ff1df893d77a5054be";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-js-sdk = {
