{
  ...
  inputs = {
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/2a21637";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-view-module-runtime = {
      url = "github:logos-co/logos-view-module-runtime/1fde7d4";
    ...
    logos-module = {
      url = "github:logos-co/logos-module/73cd9c4";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/b293e9d";
    ...
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/dd3a659";
      inputs.logos-capability-module.follows = "logos-capability-module";
    ...
    logos-module-builder = {
      url = "github:logos-co/logos-module-builder/434b98a";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
      inputs.logos-module.follows = "logos-module";
      inputs.logos-nix.follows = "logos-nix";
    ...
    nix-bundle-dir = {
      url = "github:logos-co/nix-bundle-dir/3d155ca";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    nix-bundle-lgx = {
    ...
    logos-standalone-app = {
      url = "github:logos-co/logos-standalone-app/8760d80";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-basecamp = {
      url = "github:logos-co/logos-basecamp/9b52529";
      inputs.logos-capability-module.follows = "logos-capability-module";
    ...
    logos-accounts-module = {
      url = "github:logos-co/logos-accounts-module/366f823";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    logos-accounts-ui = {
      url = "github:logos-co/logos-accounts-ui/800d68d";
    ...
    logos-package-manager = {
      url = "github:logos-co/logos-package-manager/39118d6";
      inputs.logos-nix.follows = "logos-nix";
      inputs.logos-package.follows = "logos-package";
      inputs.nix-bundle-appimage.follows = "nix-bundle-appimage";
      inputs.nix-bundle-dir.follows = "nix-bundle-dir";
    ...
    logos-package-manager-module = {
      url = "github:logos-co/logos-package-manager-module/b0401c0";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.logos-package-manager.follows = "logos-package-manager";
    };
    ...
    logos-package-manager-ui = {
      url = "github:logos-co/logos-package-manager-ui/289a17f";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    ...
    logos-wallet-ui = {
      url = "github:logos-co/logos-wallet-ui/fd075ee";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
      inputs.wallet_module.follows = "logos-wallet-module";
    };
    logos-blockchain-module = {
      url = "github:logos-blockchain/logos-blockchain-module/a574eb6";
    ...
    logos-webview-app = {
      url = "github:logos-co/logos-webview-app/93c9c4a";
      inputs.logos-module-builder.follows = "logos-module-builder";
      inputs.nix-bundle-lgx.follows = "nix-bundle-lgx";
    };
    counter_qml = {
      url = "github:logos-co/counter_qml/f2a95f3";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    counter = {
      url = "github:logos-co/counter/cc5d3a7";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-design-system = {
