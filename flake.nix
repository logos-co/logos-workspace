{
  ...
  inputs = {
    ...
    logos-cpp-sdk = {
      url = "github:logos-co/logos-cpp-sdk/676154070c7997337712be5401ae1268f2bce4cb";
    ...
    logos-liblogos = {
      url = "github:logos-co/logos-liblogos/5f8139723702a8fff7eee6ae20c042be1c72159f";
      ...
      inputs.logos-container.follows = "logos-container";
      inputs.logos-container-subprocess.follows = "logos-container-subprocess";
      inputs.logos-module-loader.follows = "logos-module-loader";
      inputs.logos-module-loader-qt.follows = "logos-module-loader-qt";
    };
    logos-logoscore-cli = {
      url = "github:logos-co/logos-logoscore-cli/0a26e6ceebcd74a6fe1ab07c57a785dcf60b3dfe";
      inputs.logos-capability-module.follows = "logos-capability-module";
      inputs.logos-cpp-sdk.follows = "logos-cpp-sdk";
    ...
    logos-libp2p-module = {
      url = "github:logos-co/logos-libp2p-module/ea9b1dff1fa2fbe9ffbc7454222ca8821f843b66";
      inputs.logos-module-builder.follows = "logos-module-builder";
    };
    logos-webview-app = {
    ...
    logos-rust-sdk = {
      url = "github:logos-co/logos-rust-sdk/5e9947247018cd4c3bb509bc82b2d7cfd91691b3";
    ...
    logos-container = {
      url = "github:logos-co/logos-container";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-container-subprocess = {
      url = "github:logos-co/logos-container-subprocess";
      inputs.logos-container.follows = "logos-container";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
    logos-module-loader = {
      url = "github:logos-co/logos-module-loader";
      inputs.logos-container.follows = "logos-container";
      inputs.logos-nix.follows = "logos-nix";
      inputs.nixpkgs.follows = "nixpkgs";
    };
