{
  ...
  inputs = {
    ...
    logos-protocol = {
      url = "github:logos-co/logos-protocol/38346dcff235db5eac0e52216588c9e34ee15562";
    ...
    logos-rust-sdk.url = "github:logos-co/logos-rust-sdk/0c298079e92d3b89e37d591b0d309a639913dd00";
    logos-logoscore-py = {
