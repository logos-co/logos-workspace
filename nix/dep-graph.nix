...
# so that `ws test --all` picks it up.
{
  ...
  logos-plugin-qt                 = { deps = [ "logos-nix" "logos-cpp-sdk" "logos-module" ]; hasTests = false; };
  logos-module-builder            = { deps = [ "logos-nix" "logos-cpp-sdk" "logos-module" "logos-plugin-qt" "nix-bundle-lgx" "logos-standalone-app" ]; hasTests = true; };
  ...
  logos-basecamp                  = { deps = [ "logos-nix" "logos-cpp-sdk" "logos-module" "logos-liblogos" "logos-capability-module" "logos-package" "nix-bundle-dir" "logos-package-manager" "logos-package-manager-module" "logos-package-downloader-module" "logos-package-manager-ui" "logos-webview-app" "counter_qml" "counter" "logos-design-system" ]; hasTests = true; };
  logos-accounts-module           = { deps = [ "logos-module-builder" "nix-bundle-lgx" ]; hasTests = false; };
  logos-accounts-ui               = { deps = [ "logos-module-builder" "nix-bundle-lgx" "logos-standalone-app" ]; hasTests = false; };
  ...
  logos-test-modules              = { deps = [ "logos-nix" "logos-liblogos" "logos-logoscore-cli" "logos-module-builder" ]; hasTests = true; };
  process-stats                   = { deps = [ "logos-nix" ]; hasTests = true; };
